package Builders;
import Domain.Bowman;
import Domain.Gender;
import java.util.List;

public class BowmanBuilder implements Builder{
    private String name;
    ...
    public Bowman build(){
        return new Bowman(name, gender, physicalAttributes, credit, force, dexterity, intelligence, endurance, speed, constitution);
    }
}
